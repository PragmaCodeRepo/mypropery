...
class PurchaseComparableSales(models.Model):
    ...
    beds = models.CharField(_("Beds"), default=0, max_length=100)
    bath = models.CharField(_("Bath"), default=0, max_length=100)
    land = models.CharField(_("Land"), default=0, max_length=100)
    garage = models.CharField(_("Garage"), default=0, max_length=100)
    location = models.CharField(
        _("Location"), choices=CHOICES, max_length=20, default="Please Select"
    )
    construction = models.CharField(
        _("Construction"), choices=CHOICES, max_length=20, default="Please Select"
    )
    accommodation = models.CharField(
        _("Accommodation"), choices=CHOICES, max_length=20, default="Please Select"
    )
    improvements = models.CharField(
        _("Improvements"), choices=CHOICES, max_length=20, default="Please Select"
    )
...
class Rooms(models.Model):
    ...
    room_thoughts = models.CharField(
        _("Thoughts"), max_length=2555, null=True, blank=True
    )
    # Per room expenses
...
class Materials(models.Model):
    ...
    quantity = models.CharField(_("Quantity"), null=True, blank=True, max_length=100)
...
class AFCAComplaintLodged(models.Model):
    ...
    mobile = models.CharField(
        _("Phone number"), validators=[mobile_regex], max_length=17, null=True, blank=True
    )  # validators should be a list
...
class ListForSale(models.Model):
    ...
    RESULT_CHOICES = (("Please Select", "Please Select"), ("Listed", "Listed"), ("Exchanged", "Exchanged"), ("Sold", "Sold"))
    deal = models.OneToOneField(
        Deal,
        on_delete=models.CASCADE,
    ...
    result = models.CharField(
        _("Sale Status"), choices=RESULT_CHOICES, max_length=50, default="Please Select"
    )
