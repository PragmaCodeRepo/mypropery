...
class Property(models.Model):
    ...
    beds = models.CharField(_("Beds"), default=1, max_length=10)
    bath = models.CharField(_("Bath"), default=1, max_length=10)
    land = models.CharField(_("Land (m2)"), default=1, max_length=10)
    garage = models.CharField(_("Garage"), default=1, max_length=10)
    ...
    number = models.CharField(_("Number"), null=True, blank=True, max_length=10)
    ...
    on_or_off_market = models.CharField(_("On Or Off Market"),max_length=30,choices=ON_OFF_CHOICES,default="ON",)
...
class Bank(models.Model):
    ...
    STATE_CHOICE = [('ACT','ACT'),('NSW','NSW'),('NT','NT'),('QLD','QLD'),('SA','SA'),('TAS','TAS'),('VIC','VIC'),('WA','WA'),('Please Select','Please Select')]
    ...
    postal_state = models.CharField(
        _("State"), max_length=100, null=True, blank=True, choices=STATE_CHOICE, default="Please Select"
    )
    postal_post_code = models.CharField(
        _("Post Code"), max_length=100, null=True, blank=True
    )
...
class Dealing(models.Model):
    ...
    registeration_number = models.CharField(_("Registeration Number"), max_length=100, null=True, blank=True)
...
class StreetAppeal(models.Model):
    ...
    street_appeal_comments = models.CharField(
        _("Comments"), max_length=2555, null=True, blank=True
    )
...
class Parking(models.Model):
    ...
    carport = models.CharField(
        _("Carport"), choices=CARPORT_CHOICES, max_length=100, default="Please Select"
    )
    carport_area = models.IntegerField(
        _("Carport Area (m2)"), null=True, blank=True
    )
    garage = models.CharField(
        _("Garage"), choices=CARPORT_CHOICES, max_length=100, default="Please Select"
    )
    garage_area = models.IntegerField(_("Garage Area (m2)"), null=True, blank=True)
    other = models.CharField(
        _("Other"), choices=OTHER_CHOICES, max_length=100, default="Please Select"
    )
...
class Features(models.Model):
    ...
    REGISTERED_CHOICES = (("YES", "YES"), ("NO", "NO"), ("Please Select", "Please Select"),)
...
class Entry(models.Model):
    ...
    floors = models.CharField(
        _("Floors"), choices=FLOORS_CHOICES, max_length=50, default="Please Select"
    )
    ...
    ceiling = models.CharField(
        _("Ceiling"), choices=CEILING_CHOICES, max_length=50, default="Please Select"
    )
    ...
    walls = models.CharField(
        _("Walls"), choices=WALLS_CHOICES, max_length=50, default="Please Select"
    )
...
class Kitchen(models.Model):
    ...
    sink = models.CharField(
        _("Sink"), choices=SINK_CHOICES, max_length=50, default="Please Select"
    )
    ...
    pantry = models.CharField(
        _("Pantry"), choices=PANTRY_CHOICES, max_length=50, default="Please Select"
    )
    # Features fields
...
class Bedroom(models.Model):
    ...
    curtains_comments = models.CharField(
        _("Other Features"), max_length=2555, null=True, blank=True
    )
