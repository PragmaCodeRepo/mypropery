...
class Contact(models.Model):
    ...
    abn_or_acn_number = models.CharField(
        _("ABN/ACN Number (Numbers Only)"), null=True, blank=True, max_length=11,
    )
    ...
    number = models.CharField(_("Number (Numbers & Letters Only)"), null=True, blank=True, max_length=11)
    ...
    rate_per_hour = models.CharField(
        _("Rate/hour ($) (Numbers Only)"), max_length=50, null=True, blank=True
    )
    trade_rating = models.CharField(
        _("Trade Rating"),
        max_length=50,
        choices=TRADE_RATING,
        default="1/5",
        null=True,
        blank=True,
    )
    ...
    license_number = models.CharField(
        _("License Number (Numbers & Letters Only)"), max_length=50, null=True, blank=True
    )
    insurance_cover_amount = models.CharField(
        _("Insurance Cover Amount ($) (Numbers Only)"),
        max_length=50,
        validators=[number_regex],
        null=True,
        blank=True,
